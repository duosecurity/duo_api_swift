...
//! Project version number for DuoAPISwift.
FOUNDATION_EXPORT double DuoAPISwiftVersionNumber;

//! Project version string for DuoAPISwift.
FOUNDATION_EXPORT const unsigned char DuoAPISwiftVersionString[];
